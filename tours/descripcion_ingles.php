        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2 class="section-heading">Caracteristicas  de nuestros  Tour´s</h2>
                    <h3 class="section-heading">Precio Especial a Grupos!</h3>
                    <hr>
                    <h4 class="section-heading"><i>Informacion Genral:</i></h4>                    
                    <p class="section-subheading text-muted">
                    	<li class="text-muted"><strong>Niños Menores de 3 Años Gratis.</strong></li>
                    	<li class="text-muted"><strong>Pagos en Efectivo</strong></li>
                    	<li class="text-muted"><strong>En nuestros precios esta incluido Iva e Impuestos</strong></li>
                    	<li class="text-muted"><strong>Todos nuestros tours incluyen Seguro de Viajeros</strong></li>
                    </p>
     <!-- Ofertas Imagen-->               
                    

<!--Fin-->
                    <h3 class="section-subheading text-muted">Escoje el tour´s que mas te agrade y contactanos!, No desperdicies esta oportunidad..</h3>
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-sm-6 portfolio-item">
                    ...
                    <div class="portfolio-caption">
                        ...
                        <p class="text-muted">Duracion:4 Horas</p>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6 portfolio-item">
                ...
                <div class="col-md-4 col-sm-6 portfolio-item">
                    ...
                    <div class="portfolio-caption">
                        ...
                        <p class="text-muted">Duracion:2 1/2 Horas</p>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6 portfolio-item">
        ...
        <a href="../index_ingles.html" class="btn-xl">Regresar</a>
    </section>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-3 col-sm-6">
                        ...
                        <img src="img/logos/logo.JPG" id="estilo1" class="img-responsive img-centered" alt="">
                   
                </div>
                <div class="col-md-3 col-sm-6">
                    
                        <img src="img/logos/comala-pueblo-magico_png_1e9c26532906369f74adf749ff6b0ae0.jpg" id="estilo1" class="img-responsive img-centered" alt="">
                    ...
                    <form name="sentMessage" id="contactForm" novalidate>
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <input type="tel" class="form-control" placeholder=" Numero Telefonico *" id="phone" required data-validation-required-message="Please enter your phone number.">
                                    <p class="help-block text-danger"></p>
                                </div>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-lg-12 text-center">
                                <div id="success"></div>
                                <button type="submit" class="btn btn-xl">Agregar Comentario</button>
                            </div>
                        </div>
                        <br>
                         <h3 class="section-subheading text-muted"><strong>
    Nuestra oficina principal está en: BLVD. MIGUEL DE LA MADRID 200-5 COL. DIECISÉIS DE SEPTIEMBRE, MANZANILLO, COLIMA.</strong></h3>
                    </form>
                </div>
            </div>
        </div>
...
<img class="img-responsive img-centered" id="estilo1" src="img/caracteristicas/7.jpg" alt="">
 ...
 <img class="img-responsive img-centered" src="img/caracteristicas/centro%20historico%20de%20Colima.jpg" id="estilo1" alt="">
 <img class="img-responsive img-centered" src="img/caracteristicas/Comala%20pueblo%20magico.jpg" id="estilo1" alt="">
 <img class="img-responsive img-centered" src="img/caracteristicas/comala.jpg" id="estilo1" alt="">
